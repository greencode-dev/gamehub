<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Modifica Piattaforma</h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.platforms.update', $platform) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $platform->name) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="manufacturer" id="manufacturer" value="{{ old('manufacturer', $platform->manufacturer) }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            @error('manufacturer')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
